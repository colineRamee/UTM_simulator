...
if __name__ == '__main__':
    ...
    sim = simulation.Simulation(length_arena, n_intruder, minimum_separation, max_speed,
                                ...
                                update_queue=update_queue, stdout_to_file=True, n_layers=n_layers)
    dis = display.LayeredDisplay(2, update_queue, length_arena, display_update=20 * time_step, static_obstacles=static_obstacles)
    sim.run()
    dis.run()
