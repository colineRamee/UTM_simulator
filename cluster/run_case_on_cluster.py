...
""" Takes as command line input the name of the input file and the number of the simulation to be run from the input file"""

with open(sys.argv[-2]) as f:
    data = json.load(f)

if str(sys.argv[-1]) in data:
    input_parameters = data[str(sys.argv[-1])]
